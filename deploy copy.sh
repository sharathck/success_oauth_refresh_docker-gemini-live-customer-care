...
echo "Executing: git commit -m 'Deploying the latest build'"
...
echo "Executing: git push origin main 2>&1 | tee git_push.log"
git push origin main 2>&1 | tee git_push.log

# check if the git push was successful
if [ $? -ne 0 ]; then
    echo "ERROR ERROR ERROR  :::::::::::::   ERROR ERROR ERROR  ::::::::::: Git push failed. Please check the logs for more details."
    exit 1
fi
if grep -qi "error" git_push.log; then
    echo "ERROR ERROR ERROR  :::::::::::::   ERROR ERROR ERROR  ::::::::::: Git push failed with errors. Please check git_push.log for details."
    exit 1
fi
